...
<head>
    <meta charset="utf-8">
    <title>Dokumen Baptis Anak</title>
    <style>
...
<body>
    ...
    <div class="content">
        ...
        <table class="data-table">
            <tr><td class="label">Nama Anak</td><td class="value">{{ $childName ?? '-' }}</td></tr>
            ...
            <tr><td class="label">Tanggal Baptis</td><td class="value">{{ $baptismDate ?? '-' }}</td></tr>
            <tr><td class="label">Tanggal Diterbitkan</td><td class="value">{{ $issuedAt ?? '-' }}</td></tr>
        </table>
        <p>Telah dibaptis sebagai anak, sesuai dengan tata ibadah Gereja {{ $churchName ?? '' }}.</p>
    </div>
